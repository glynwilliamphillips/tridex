...
//height_abd = new Array(I777);	//top_displacement+ HTU_*d_height + HTU_b * b_height + HTU_a * a_height;
left_abd = new Array(I777);
cube_colour = new Array(I777);
cube_letter = new Array(I777);
cube_HTML = new Array(I777);
...
var answer_directions = new Array(I777);
...
for(i = 0; i < I777; i++) {
	temp_cube = mini_cubes[i];
	//console.log('temp_cube['+i+']='+temp_cube);
	temp_cube.display_height = 99;
	temp_cube.display_left[i] = 400;
	temp_cube.cube_colour = 'black';
	temp_cube.cube_letter = '_';
	temp_cube.cube_HTML = '';
}
*/
...
*/			
function populate_mini_cubes() {
	console.log('populate_mini_cubes()');
	/* fill all holes black unless otherwise stated */
	//console.log('before '+mini_cubes[1].cube_direction);
	for (i = 0; i < I777; i++){
		thiscube = mini_cubes[i];
		//console.log('thiscube='+thiscube);
		thiscube.cube_direction = '■';
		
	}
	//console.log('after '+mini_cubes[1].cube_direction);
...
/*
	...
	//	console.log('b='+b);
		for (x in arr135) {	
			a = arr135[x];
			index = a*49+b*7+d;
			thiscube = mini_cubes[index];
			//console.log('111: thiscube='+thiscube);
			thiscube.cube_direction = 'd';	//down
			//console.log('thiscube.cube_direction = '+thiscube.cube_direction);
		}
	}
	show_data_load = false;
	if(show_data_load) {
		...
		for (b = 0; b <7; b++) {
			...
			for (a = 0; a < 7; a++) {
				index = a*49 + b*7 + d;
				thiscube = mini_cubes[index];
				//console.log('131: thiscube='+thiscube+'direction='+thiscube.cube_direction);
				line = line + thiscube.cube_direction;
			}
