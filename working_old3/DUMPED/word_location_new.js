...
/*
This diagram show ABD as digits rather than by 7s
						■
					561		651
				■		551		■
			361		451		541		631
		■		351		■		531		■	
	161		251		341		431		521		61?	
■		151	■		■	331		■		511		■
	051		141		231		321		411		50?		6
5		■		131		■		311		■		5
	4		031		121		211		301		4
		3		■		111		■		3A^
	B^		2		011		101		2
...
function do_interesting_word() {
	console.log('interesting word at'+word_HTUs);
}
