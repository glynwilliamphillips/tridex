...
create a cube using
fred = new Cube(index,1,2,3, slice) 
where Across coordinate is 1, Behind coord 2 & Climb coord 3
index = C * 49 + B * 7 + A
The list of Cubes is called mini_cubes[]*/
/* There are a full set of minicubes per slice (or maybe reduced number! */

function Cube(index, a,b,c, slice) {
...
function compute_pattern(myCube) {
	...
	myCube.display_top = slice_number * top_displacement   - myCube.height_C - myCube.height_A - myCube.height_B ;
